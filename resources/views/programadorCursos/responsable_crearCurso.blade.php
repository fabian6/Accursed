                    ...
                    <div class="row mt">
                        ...
                        <form method="POST" action="{{ route('crearcurso') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="fecha_final" type="date" class="form-control @error('fecha_final') is-invalid @enderror" name="fecha_final" required >
                            ...
                            <!-- Exclusivo -->
                            <div class="form-group row">
                                <label for="exclusivo" class="col-md-4 col-form-label text-md-right">{{ __('Exclusivo?') }}</label>
                    
                                <div class="col-md-6">
                                    <input  type="checkbox" class="form-control" name="exclusivo"  >
                                </div>
                            </div>
